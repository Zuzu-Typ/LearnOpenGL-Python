...
def main() -> int:
    ...
    # load textures
    # -------------
    diffuseMap = loadTexture("bricks2.jpg")
    normalMap = loadTexture("bricks2_normal.jpg")
    heightMap = loadTexture("bricks2_disp.jpg")
    # diffuseMap = loadTexture("toy_box_diffuse.png")
    # normalMap = loadTexture("toy_box_normal.png")
    # heightMap = loadTexture("toy_box_disp.png")
    ...
    while (not glfwWindowShouldClose(window)):
        ...
        model = glm.mat4(1.0)
        model = glm.rotate(model, glm.radians(glfwGetTime() * -10.0), glm.normalize(glm.vec3(1.0, 0.0, 1.0))) # rotate the quad to show parallax mapping from multiple directions
