def main() -> int:
    ...
    while(not glfwWindowShouldClose(window))
        ...
        transform = glm.rotate(transform, glfwGetTime(), glm.vec3(0.0, 0.0, 1.0)) # switched the order
        transform = glm.translate(transform, glm.vec3(0.5, -0.5, 0.0)) # switched the order               
        [...]
