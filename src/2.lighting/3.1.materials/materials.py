...
def main() -> int:
    ...
    # ------------------------------------
    lightingShader = Shader("3.1.materials.vs", "3.1.materials.fs")
    lightCubeShader = Shader("3.1.light_cube.vs", "3.1.light_cube.fs")
    ...
    while (not glfwWindowShouldClose(window)):
        ...
        # light properties
        lightColor = glm.vec3()
        lightColor.x = glm.sin(glfwGetTime() * 2.0)
        lightColor.y = glm.sin(glfwGetTime() * 0.7)
        lightColor.z = glm.sin(glfwGetTime() * 1.3)
