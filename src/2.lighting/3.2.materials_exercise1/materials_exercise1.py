...
def main() -> int:
    ...
    # ------------------------------------
    lightingShader = Shader("3.2.materials.vs", "3.2.materials.fs")
    lightCubeShader = Shader("3.2.light_cube.vs", "3.2.light_cube.fs")
    ...
    while (not glfwWindowShouldClose(window)):
        ...
        # light properties
        lightingShader.setVec3("light.ambient", 1.0, 1.0, 1.0) # note that all light colors are set at full intensity
        ...
        lightingShader.setVec3("material.diffuse", 0.0, 0.50980392, 0.50980392)
