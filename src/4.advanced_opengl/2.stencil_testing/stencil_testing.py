...
def main() -> int:
    ...
    shaderSingleColor = Shader("2.stencil_testing.vs", "2.stencil_single_color.fs")
    ...
    while (not glfwWindowShouldClose(window)):
        ...
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT) # don't forget to clear the stencil buffernot 
